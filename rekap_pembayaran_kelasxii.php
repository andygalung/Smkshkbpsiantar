...
$query = "SELECT * FROM pembayaran_xii $whereClause ORDER BY tanggal_pembayaran DESC";
$result = $conn->query($query);

// Hitung total pembayaran
$totalQuery = "SELECT SUM(jumlah_bayar) as total FROM pembayaran_xii $whereClause";
$totalResult = $conn->query($totalQuery);
$totalRow = $totalResult->fetch_assoc();
$totalPembayaran = $totalRow['total'] ?? 0;

// Hitung jumlah siswa
$siswaQuery = "SELECT COUNT(DISTINCT nama_siswa) as jumlah_siswa FROM pembayaran_xii $whereClause";
...
if (isset($_GET['export']) && $_GET['export'] == "pdf") {
    ...
    $pdf->SetTitle("Rekap Pembayaran Kelas XII");
    ...
    $pdf->Cell(0, 10, "REKAP PEMBAYARAN KELAS XII", 0, 1, 'C');
    $pdf-> Ln(8);
...
$pdf->Cell(0, 10, '(____________________)', 0, 1, 'R');
    ...
    // Output PDF
    $pdf->Output("Rekap_Pembayaran_Kelas_XII.pdf", 'D');
    exit();
}
?>
...
<head>
    ...
    <title>Rekap Pembayaran Kelas XII - SMK SHK BPSiantar</title>
        ...
        <div class="page-header mb-4 animate-fade-in">
            <div class="page-header-content">
                <div class="row align-items-center">
                    <div class="col">
                        <h2><i class="fas fa-file-invoice-dollar me-2"></i>Rekap Pembayaran Kelas XII</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Rekap Pembayaran Kelas XII</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-auto">
